  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold" style={{ color: 'var(--ink)' }}>Other Materials ({materials.length})</h3>
        </div>
      ...
      {Object.keys(categoryTotals).length > 0 && (
        <div className="bg-surface rounded-xl p-5" style={{ border: '1px solid var(--border)' }}>
          <h4 className="text-sm font-semibold mb-3 uppercase tracking-wider" style={{ color: 'var(--brand-cyan)' }}>Material Totals</h4>
              ...
              {materials.length === 0 ? (
                ...
                materials.map(m => (
                  <tr key={m.id}>
                    ...
                    <td className="font-semibold" style={{ color: 'var(--ink)' }}>{formatCurrency(m.amount)}</td>
                    <td>
          ...
          <div className="modal-overlay" onClick={() => setShowCreate(false)}>
            <div className="modal-content max-w-xl" onClick={e => e.stopPropagation()}>
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold" style={{ color: 'var(--ink)' }}>Add Other Material</h2>
